# Device control policy sample: Step 3 - Allow different access to different devices
...
<table>
    ...
    <tr>
		...
		<th>File Execute</th></tr><tr>
            <td rowspan="2" valign="top"><b>Step 3 - Deny all other USBs</b></td>
...
<li>Group: Readonly USBs<a href="#readonly-usbs" title="MatchAny {'VID_PID': '090C_1000'}"> (details)</a>  
            ...
            <td rowspan="1" valign="top"><b>Step 3 - Allow Full Access to Writeable USBs</b></td>
            ...
            <td rowspan="1" valign="top"><b>Step 3 - Allow Read Only Access to Read Only USBs</b></td>
            <td rowspan="1 valign="top">
...
- [windows/Getting Started/Step 3/allow_different_access_to_different_rules.xml](/windows/Getting%20Started/Step%203/allow_different_access_to_different_rules.xml)
...
<summary>Add a row for Step 3 - Deny all other USBs</summary>  
   ...
   6. For Custom XML, select  *windows\Getting Started\Intune OMA-URI\step_3_-_deny_all_other_usbs{7beca8fe-313a-46f2-a090-399eb3d74318}.xml*
...
<summary>Add a row for Step 3 - Allow Full Access to Writeable USBs</summary>  
   ...
   6. For Custom XML, select  *windows\Getting Started\Intune OMA-URI\step_3_-_allow_full_access_to_writeable_usbs{a054bbcf-3454-4b95-9058-f7ed00deeee9}.xml*
...
<summary>Add a row for Step 3 - Allow Read Only Access to Read Only USBs</summary>  
   ...
   6. For Custom XML, select  *windows\Getting Started\Intune OMA-URI\step_3_-_allow_read_only_access_to_read_only_usbs{b2b9cfc0-799d-457c-babc-da617d9a8b83}.xml*
