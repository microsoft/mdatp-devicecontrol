...
<table>
    ...
    <tr>
		...
		<th>File Execute</th></tr><tr>
            <td rowspan="2" valign="top"><b>Step 5 - Deny all other USBs</b></td>
...
<li>Group: Readonly USBs<a href="#readonly-usbs" title="MatchAny {'VID_PID': '090C_1000'}"> (details)</a>  
            ...
            <td rowspan="2" valign="top"><b>Step 5 - Allow Access to Writeable USBs for some users and files and capture file evidence</b></td>
            <td rowspan="2 valign="top">
                <ul><li>Group: Authorized USBs<a href="#authorized-usbs" title="MatchAny {'InstancePathId': 'USB\\VID_154B&PID_0028\\6EA9150055800605'}"> (details)</a>  
</ul>
            </td>
            ...
            <td> 
                <details>
                <summary>View</summary>
                User: S-1-1-0<br>MatchAll:
                <ul><li> Windows File: MatchAll 
                        <ul><li>Group: Non Restricted File Types<a href="#non-restricted-file-types" title="MatchExcludeAny {'PathId': '*.docx'}"> (details)</a>  
</ul>
                </ul>
                </details>
                </td>
        </tr><tr>
            <td rowspan="1" valign="top"><b>Step 5 - Allow Read Only Access to Read Only USBs for some users</b></td>
...
- [windows/Getting Started/Intune OMA-URI/non_restricted_file_types{940973b7-dacd-4d2f-88f9-1141e20a3b7c}.xml](/windows/Getting%20Started/Intune%20OMA-URI/non_restricted_file_types%7B940973b7-dacd-4d2f-88f9-1141e20a3b7c%7D.xml)
