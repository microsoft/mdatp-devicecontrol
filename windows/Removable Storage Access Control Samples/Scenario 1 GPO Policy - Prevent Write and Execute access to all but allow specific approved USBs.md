...
<summary>Add a row for Audit Write and Execute access to aproved USBs</summary>  
   ...
   6. For Custom XML, select  *windows\Removable Storage Access Control Samples\Group Policy\Scenario 1 GPO Policy - Prevent Write and Execute access to all but allow specific approved USBs.xml*
