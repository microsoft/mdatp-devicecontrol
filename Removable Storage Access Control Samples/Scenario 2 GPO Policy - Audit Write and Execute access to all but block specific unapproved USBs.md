...
<summary>Add a row for Block Write and Execute access to all but block specific unapproved USBs</summary>  
   ...
   6. For Custom XML, select  *.\Group Policy\block_write_and_execute_access_to_all_but_block_specific_unapproved_usbs{23b8e437-66ac-4b32-b3d7-24044637fc98}.xml*
...
<summary>Add a row for Audit Write and Execute access to others</summary>  
   ...
   6. For Custom XML, select  *.\Group Policy\audit_write_and_execute_access_to_others{b58ab853-9a6f-405c-a194-740e69422b48}.xml*
